...
class TestEventId(unittest.TestCase):
    ...
    def test_unpack(self):
        ...
        cid_02, state_02, timestamp = EventId.unpack(event_id)
    ...
    def test_basic_01(self):
        ts = moment('2021-01-02 12:23:22')
        eid = EventId(0, 0, ts)
        cid_01, state_01, timestamp_01 = EventId.unpack(str(eid))
        eid_01 = EventId(cid_01.value, state_01.value, timestamp_01)
        self.assertEqual(eid_01.core, eid.core)

    def test_basic_02(self):
        ts = moment('2021-01-02 12:23:22')
        eid = EventId(0, 0, ts)
        cid_01, state_01, timestamp_01 = EventId.unpack(eid)
        eid_01 = EventId(cid_01.value, state_01.value, timestamp_01)
    ...
    def test_error_04(self):
        with self.assertRaises(ValueError):
            EventId.unpack('8080100e4e14c14000')
